...
export const iconButtonVariants = cva(
    "inline-flex items-center justify-center shrink-0 size-9 p-2 rounded-lg transition-colors duration-200 ease-out outline-none disabled:pointer-events-none disabled:cursor-not-allowed focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-border-focus",
    {
        variants: {
            variant: {
                primary:
